        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-12 mb-12">
          ...
          <div className="space-y-5">
            ...
            <div className="flex gap-4 pt-2">
              <a href="#" className="w-8 h-8 rounded-full border border-[#E6C587]/20 flex items-center justify-center text-[#E6C587]/70 hover:text-[#E6C587] hover:border-[#E6C587]/60 hover:bg-[#E6C587]/5 transition-all duration-300">
